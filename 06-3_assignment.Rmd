...
```{r}
SupplementaryRawDataR2 <- read_excel("raw_data/SupplementaryRawDataR2.xlsx", sheet = "Sheet1")
...
Here is a template for your plot code. Uncomment the below (highlight and click Code>Comment/Uncomment Lines) and fill in the underscore blanks and ellipses (...). Be sure that the plot contains proper labels, etc. 
